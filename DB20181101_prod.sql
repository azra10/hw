...
DROP TABLE IF EXISTS lh3i_iss_assignment;
CREATE TABLE IF NOT EXISTS lh3i_iss_assignment (
  ...
  PRIMARY KEY (ID),
  KEY ClassID (ClassID),
  KEY Assignment_TypeID_FK (AssignmentTypeID)
...
DROP TABLE IF EXISTS lh3i_iss_assignment_type;
...
) ENGINE=InnoDB AUTO_INCREMENT=282 DEFAULT CHARSET=latin1 AUTO_INCREMENT=282 ;
...
DROP TABLE IF EXISTS lh3i_iss_class;
...
DROP TABLE IF EXISTS lh3i_iss_grading_period;
...
DROP TABLE IF EXISTS lh3i_iss_scale;
...
) ENGINE=InnoDB AUTO_INCREMENT=124 DEFAULT CHARSET=latin1 AUTO_INCREMENT=124 ;
...
DROP TABLE IF EXISTS lh3i_iss_score;
...
DROP TABLE IF EXISTS lh3i_iss_student;
...
DROP TABLE IF EXISTS lh3i_iss_userclassmap;
...
DROP TABLE IF EXISTS lh3i_iss_userstudentmap;
...
CREATE ALGORITHM=UNDEFINED DEFINER=clgtvldtvxadnshf@`10.%` SQL SECURITY DEFINER VIEW issadmin_lh3i_cxopdckmhsrrlmvqxr.lh3i_issv_class_assignments AS select d.ClassID AS ClassID,d.DueDate AS DueDate,d.Category AS Category,d.PossiblePoints AS PossiblePoints,d.AssignmentTypeID AS AssignmentTypeID,c.ISSGrade AS ISSGrade,c.RegistrationYear AS RegistrationYear,c.`Subject` AS `Subject`,p.ID AS ID,p.post_author AS post_author,p.post_date AS post_date,p.post_content AS post_content,p.post_title AS post_title,p.post_status AS post_status,p.post_name AS post_name,p.guid AS guid,p.post_type AS post_type from ((issadmin_lh3i_cxopdckmhsrrlmvqxr.lh3i_iss_assignment d join issadmin_lh3i_cxopdckmhsrrlmvqxr.lh3i_posts p) join issadmin_lh3i_cxopdckmhsrrlmvqxr.lh3i_iss_class c) where ((d.ID = p.ID) and (c.ClassID = d.ClassID));
...
CREATE ALGORITHM=UNDEFINED DEFINER=clgtvldtvxadnshf@`10.%` SQL SECURITY DEFINER VIEW issadmin_lh3i_cxopdckmhsrrlmvqxr.lh3i_issv_class_students AS select C.ClassID AS ClassID,S.StudentViewID AS StudentViewID,S.StudentID AS StudentID,S.StudentFirstName AS StudentFirstName,S.StudentLastName AS StudentLastName,S.StudentGender AS StudentGender from (issadmin_lh3i_cxopdckmhsrrlmvqxr.lh3i_iss_class C join issadmin_lh3i_cxopdckmhsrrlmvqxr.lh3i_iss_student S) where ((S.ISSGrade = C.ISSGrade) and (S.StudentStatus = 'active') and (C.`Status` = 'active') and (S.RegistrationYear = C.RegistrationYear));
...
CREATE ALGORITHM=UNDEFINED DEFINER=clgtvldtvxadnshf@`10.%` SQL SECURITY DEFINER VIEW issadmin_lh3i_cxopdckmhsrrlmvqxr.lh3i_issv_classes AS select C.ClassID AS ClassID,C.RegistrationYear AS RegistrationYear,C.ISSGrade AS ISSGrade,C.`Subject` AS `Subject`,C.`Status` AS `Status`,U.ID AS UserID,U.user_email AS UserEmail,M.Access AS Access,U.display_name AS Teacher,M.LastLogin AS LastLogin from ((issadmin_lh3i_cxopdckmhsrrlmvqxr.lh3i_iss_class C left join issadmin_lh3i_cxopdckmhsrrlmvqxr.lh3i_iss_userclassmap M on((M.ClassID = C.ClassID))) left join issadmin_lh3i_cxopdckmhsrrlmvqxr.lh3i_users U on((M.UserID = U.ID)));
...
CREATE ALGORITHM=UNDEFINED DEFINER=clgtvldtvxadnshf@`10.%` SQL SECURITY DEFINER VIEW issadmin_lh3i_cxopdckmhsrrlmvqxr.lh3i_issv_student_class_access AS select S.StudentViewID AS StudentViewID,S.StudentFirstName AS StudentFirstName,S.StudentLastName AS StudentLastName,C.ClassID AS ClassID,S.RegistrationYear AS RegistrationYear,C.ISSGrade AS ISSGrade,C.`Subject` AS `Subject`,C.Suffix AS Suffix,M.UserID AS UserID,M.Access AS Access from ((issadmin_lh3i_cxopdckmhsrrlmvqxr.lh3i_iss_student S join issadmin_lh3i_cxopdckmhsrrlmvqxr.lh3i_iss_userstudentmap M) join issadmin_lh3i_cxopdckmhsrrlmvqxr.lh3i_iss_class C) where ((M.StudentID = S.StudentID) and (C.ISSGrade = S.ISSGrade) and (C.`Status` = 'active') and (S.StudentStatus = 'active') and (C.RegistrationYear = '2018-2019') and (S.RegistrationYear = '2018-2019'));
...
CREATE ALGORITHM=UNDEFINED DEFINER=clgtvldtvxadnshf@`10.%` SQL SECURITY DEFINER VIEW issadmin_lh3i_cxopdckmhsrrlmvqxr.lh3i_issv_student_lastlogin AS select issadmin_lh3i_cxopdckmhsrrlmvqxr.lh3i_iss_userstudentmap.StudentID AS StudentID,max(issadmin_lh3i_cxopdckmhsrrlmvqxr.lh3i_iss_userstudentmap.LastLogin) AS LastLogin from issadmin_lh3i_cxopdckmhsrrlmvqxr.lh3i_iss_userstudentmap where (issadmin_lh3i_cxopdckmhsrrlmvqxr.lh3i_iss_userstudentmap.LastLogin is not null) group by issadmin_lh3i_cxopdckmhsrrlmvqxr.lh3i_iss_userstudentmap.StudentID;
...
CREATE ALGORITHM=UNDEFINED DEFINER=clgtvldtvxadnshf@`10.%` SQL SECURITY DEFINER VIEW issadmin_lh3i_cxopdckmhsrrlmvqxr.lh3i_issv_student_scores AS select S.StudentViewID AS StudentViewID,A.ID AS AssignmentID,A.AssignmentTypeID AS AssignmentTypeID,A.DueDate AS DueDate,A.PossiblePoints AS PossiblePoints,G.Score AS Score,G.`Comment` AS `Comment`,C.ClassID AS ClassID,P.post_title AS Title,S.StudentFirstName AS StudentFirstName,S.StudentLastName AS StudentLastName,S.ISSGrade AS ISSGrade,C.`Subject` AS `Subject` from ((((issadmin_lh3i_cxopdckmhsrrlmvqxr.lh3i_iss_assignment A join issadmin_lh3i_cxopdckmhsrrlmvqxr.lh3i_posts P on((A.ID = P.ID))) join issadmin_lh3i_cxopdckmhsrrlmvqxr.lh3i_iss_class C on((A.ClassID = C.ClassID))) join issadmin_lh3i_cxopdckmhsrrlmvqxr.lh3i_iss_student S on((C.ISSGrade = S.ISSGrade))) left join issadmin_lh3i_cxopdckmhsrrlmvqxr.lh3i_iss_score G on(((G.AssignmentID = A.ID) and (G.StudentViewID = S.StudentViewID)))) where (S.StudentStatus = 'active');
...
CREATE ALGORITHM=UNDEFINED DEFINER=clgtvldtvxadnshf@`10.%` SQL SECURITY DEFINER VIEW issadmin_lh3i_cxopdckmhsrrlmvqxr.lh3i_issv_teacher_class_access AS select C.ClassID AS ClassID,C.RegistrationYear AS RegistrationYear,C.ISSGrade AS ISSGrade,C.`Subject` AS `Subject`,C.Suffix AS Suffix,M.UserID AS UserID,M.Access AS Access from (issadmin_lh3i_cxopdckmhsrrlmvqxr.lh3i_iss_class C join issadmin_lh3i_cxopdckmhsrrlmvqxr.lh3i_iss_userclassmap M) where ((C.`Status` = 'active') and (C.ClassID = M.ClassID));
...
CREATE ALGORITHM=UNDEFINED DEFINER=clgtvldtvxadnshf@`10.%` SQL SECURITY DEFINER VIEW issadmin_lh3i_cxopdckmhsrrlmvqxr.lh3i_issv_teacher_name AS select M.ClassID AS ClassID,M.UserID AS UserID,U.display_name AS Teacher,M.Access AS Access from (issadmin_lh3i_cxopdckmhsrrlmvqxr.lh3i_iss_userclassmap M join issadmin_lh3i_cxopdckmhsrrlmvqxr.lh3i_users U) where (U.ID = M.UserID);
...
-- 
-- Constraints for table `lh3i_iss_assignment`
-- 
ALTER TABLE `lh3i_iss_assignment`
  ADD CONSTRAINT Assignment_TypeID_FK FOREIGN KEY (AssignmentTypeID) REFERENCES lh3i_iss_assignment_type (AssignmentTypeID);
