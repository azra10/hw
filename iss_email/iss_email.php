...
function iss_email_school_page()
{
    include(plugin_dir_path(__FILE__) . "/email_school.php");
}
function iss_email_register_menu_page()
{
    ...
    $my_pages[] = add_menu_page('Email School', 'Email School', 'iss_board', 'issemailschool', 'iss_email_school_page', 'dashicons-email', 9999);
