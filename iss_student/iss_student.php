...
function student_progress_page()
{
    include(plugin_dir_path(__FILE__) . "/student_progress.php");
}
function editstudent_progress_page()
{
    include(plugin_dir_path(__FILE__) . "/student_progress_edit.php");
}    
function iss_student_register_menu_page()
{
    ...
    $my_pages[] = add_submenu_page(null, 'Student Progress', 'Student Progress', 'iss_student', 'issvstudentprogress', 'student_progress_page');
    $my_pages[] = add_submenu_page(null, 'Student Progress', 'Student Progress', 'iss_teacher', 'issveditstudentprogress', 'editstudent_progress_page');
